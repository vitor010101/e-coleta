...
const CreatePoint = () => {
  ...
  const [cities, setCities] = useState<CitiesIBGEresponse[]>([]);
  ...
  return (
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <ul className="items-grid">
            {items.map((item) => (
              <li
                key={item.id}
                onClick={() => hundleSelectedItem(item.id)}
        ...
        <button type="submit">Cadastrar novo ponto</button>
      </form>
    </div>
  );
};
